...
function displayPics(){
  ...
  // The scope of 'let' is limited to the block, statement, or expression where it is defined and used. Since console.log(rando) is outside of the block where the variable is defined, we get an error stating that 'rando' is not defined.
  console.log(viewed)
